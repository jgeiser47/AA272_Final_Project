%==========================================================================
%
% deputy2_parameters  Returns the deputy 2 spacecraft parameters.
%
%   deputy2 = deputy2_parameters
%
% Author: Tamas Kis
...
% OUTPUT:
% -------
%   deputy2 - (1×1 struct) deputy 2 satellite parameters
...
%
%==========================================================================
function deputy2 = deputy2_parameters
    ...
    % properties
    props.m = 6;        % mass [kg]
    props.AD = 0.045;   % atmospheric drag reference area [m^2]
    ...
    deputy2 = initialize_deputy(chief,props,ROE);
