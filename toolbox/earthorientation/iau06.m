...
% CIO based theory.
%
%   [R_itrf2gcrf,R_gcrf2itrf,Q,R,W] = iau06(MJD_UT1,MJD_TT,xp,yp,dX,dY,...
%       XYs_iau06)
%
% See also eop_iau06.
%
...
%   w_ITRF      - (3×1 double) Earth angular velocity resolved in ITRF 
%                 [rad/s]
...
%
%==========================================================================
function [R_itrf2gcrf,R_gcrf2itrf,w_itrf,Q,R,W] = iau06(MJD_UT1,MJD_TT,...
