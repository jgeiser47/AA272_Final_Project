...
% ----------------------
%
% This script produces "Kp_ap_F107.mat" which stores the N×20 array 
% "Kp_ap_F107", where N is the number of dates. The columns store the 
% following data:
...
Kp_ap_F107 = [MJD_UT1,Kp,ap,Ap,F107,F107_avg];

% saves Kp_ap_F107 as a .mat file
save('../datafiles/Kp_ap_F107.mat','Kp_ap_F107');