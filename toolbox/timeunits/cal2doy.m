...
%
% See also cal2mjd, f2hms, hms2f, jd2mjd, jd2t, mjd2cal, mjd2jd, mjd2t.
%
% Author: Tamas Kis
...
function DOY = cal2doy(cal)
    ...
    % extracts year, month, and day from Gregorian date
    YYYY = cal(1);
    MM = cal(2);
    DD = cal(3);
    ...
    % changes the number of days in February to 29 if in leap year
    if mod(YYYY,4) == 0
        d(2) = 29;
    end
